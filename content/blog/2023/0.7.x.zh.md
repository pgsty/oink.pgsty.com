...
正如[上一篇文章](/zh/blog/2023/bootstrap-5-migration/#migrating-docsy-based-projects)所述，每个项目使用的 Bootstrap 与 Docsy 功能组合都不相同，因此**你的升级之路很可能独一无二**。本节给出一些通用建议。
