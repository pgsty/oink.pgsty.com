...
- 存在 Markdown 备用版本时显示_查看 Markdown_页面元数据链接。
...
Docsy 对_文档根站点_提供了新的改进支持，即把 `docs` 分区发布到站点根路径，而不是
`/docs/` 下。这适用于以文档为主体、希望 URL 更短的站点，例如使用 `/get-started/`
而不是 `/docs/get-started/`。
