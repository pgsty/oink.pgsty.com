...
ECharts accepts structured JSON or YAML by default. Legacy JavaScript requires
an explicit unsafe opt-in, making the migration exception visible and removable.
...
- ECharts structured-data and unsafe-code boundaries;
