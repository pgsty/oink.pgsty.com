...
**Release date:** 2026-08-10 · **Theme tag:**
[v0.2.0](https://github.com/pgsty/oink/tree/v0.2.0) · **Repository:**
...
See [Homepage and footer](/docs/content/configuration/#homepage-and-footer) for
the complete data shape.
...
See [Shortcodes](/docs/content/shortcodes/#steps) for the new steps contract and
[Oink components](/docs/content/components/) for the broader component model.
