...
**发布日期**：2026-08-10 · **主题标签**：
[v0.2.0](https://github.com/pgsty/oink/tree/v0.2.0) · **代码仓库**：
...
完整数据结构参见[首页与页脚](/zh/docs/content/configuration/#homepage-and-footer)。
...
新 `steps`
契约参见[短代码](/zh/docs/content/shortcodes/#steps)，完整组件模型参见
[Oink 组件](/zh/docs/content/components/)。
