...
[alert 短代码]: /zh/docs/components/layout/#alert
[告警]: /zh/docs/content/writing/#alerts
...
[内部]: https://github.com/google/docsy/blob/main/CHANGELOG.md
...
[自定义导航栏]: /zh/docs/appearance/styling/#navbar-customization
[浅色/深色主题]: /zh/docs/appearance/styling/#navbar-lightdark-theme
[导航栏]: /zh/docs/appearance/styling/#navbar
[navbar-lightdark-theme]: /zh/docs/appearance/styling/#navbar-lightdark-theme
[导航栏首屏图片半透明]: /zh/docs/appearance/styling/#customize-over-cover
...
[heading-aliases+]: /zh/docs/configure/navigation/#heading-aliases
[heading-aliases-impl-notes]:
  /zh/docs/configure/navigation/#heading-aliases-implementation-notes
...
[破坏性变更]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[Swagger UI]: /zh/docs/components/layout/#swaggerui
...
[导航栏下方高度调整]: /zh/docs/components/layout/#td-below-navbar
[blocks/cover]: /zh/docs/components/layout/#blocks-cover
...
[浅色/深色代码样式及其他配置]:
  /zh/docs/appearance/styling/#lightdark-code-styles
[选择控制台代码块内容]:
  /zh/docs/appearance/styling/#selecting-console-block-content
...
[额外样式]: /zh/docs/appearance/styling/#extra-styles

### 短代码 {#shortcodes}

- 新增[实验性][experimental] `td/site-build-info/netlify`
  短代码，用于显示 Netlify 构建信息。见[示例](https://github.com/pgsty/oink.pgsty.com)。

### 明确公开功能与内部主题功能 {#clarified-public-vs-internal-theme-features}

Docsy
0.14.0 新增[定义](https://github.com/google/docsy/blob/main/CHANGELOG.md)，明确公开定制表面、内部/私有功能与支持边界，使读者知道哪些内容得到支持、哪些变更需要操作：

- [公开定制表面](https://github.com/google/docsy/blob/main/CHANGELOG.md)
- [私有/内部功能](https://github.com/google/docsy/blob/main/CHANGELOG.md)
- [实验性功能][experimental]
- [破坏性变更](https://github.com/google/docsy/blob/main/CHANGELOG.md)
- [正式支持边界](https://github.com/google/docsy/blob/main/CHANGELOG.md)
...
- [0.13.0 升级指南](/zh/blog/docsy/0.13.0/)
...
[高级样式定制]: /zh/docs/appearance/styling/#advanced-style-customization
...
[hugo-0.152.0+]: /zh/blog/docsy/hugo-0.152.0+/
[正式支持]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[项目样式文件]: /zh/docs/appearance/styling/#project-style-files
[项目样式]: /zh/docs/appearance/styling/#project-styles
[技术债务]: https://martinfowler.com/bliki/TechnicalDebt.html
[测试清单]: /zh/blog/docsy/0.12.0/#testing-checklist
[升级到 Docsy 0.12.0]: /zh/blog/docsy/0.12.0/
[升级到 Docsy 0.13.0]: /zh/blog/docsy/0.13.0/
