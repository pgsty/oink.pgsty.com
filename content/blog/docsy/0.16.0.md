...
> - <i class="fa-solid fa-star text-info fa-lg"></i>
>   <span>**[Favicons](#favicons)**: drop your icons into `static/` and Docsy
>   does the rest</span>
> - <i class="fa-solid fa-bolt text-warning fa-lg"></i>
>   <span>**[Shared chrome](#shared-chrome)** (experimental): a build mode for
>   much faster link checking of large sites</span>
...
- Review {{< badge text="BREAKING" tone="warning" >}} changes:
  ...
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Minimum Hugo version](#hugo)
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Default favicons removed](#favicons)
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
...
- Optionally skim:
  - <i class="fa-regular fa-square-check fa-lg text-success px-1"></i>
    [Docsy on the npm registry](#npm-registry)
  - <i class="fa-regular fa-square-check fa-lg text-success px-1"></i>
    [Favicon discovery](#favicons)
  - <i class="fa-regular fa-square-check fa-lg text-success px-1"></i>
    Experimental [shared chrome build mode](#shared-chrome)
  - <i class="fa-regular fa-wand-magic-sparkles fa-lg text-info px-1"></i>
    [PostCSS is opt-in for non-RTL sites](#postcss)
  - [Other notable changes](#other-notable-changes), and
    [for maintainers](#for-maintainers)
- <i class="fa-solid fa-rocket text-primary px-1"></i> Jump to
  [Upgrade to 0.16.0](#upgrade) yourself, or
  [ask an AI agent](#upgrading-with-ai).
...
<i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
**Applies if** your site keeps Docsy under `themes/docsy/` as a clone or Git
submodule.
...
<i class="fa-regular fa-square-check fa-lg text-success px-1"></i> **Applies
if** your site installs Docsy from GitHub with npm (`google/docsy#semver:…`).
...
if** your site has no RTL language and no `postcss.config.*` of its own.
...
<i class="fa-regular fa-square-check fa-lg text-success px-1"></i> **Applies
if** you want faster link-checking, output diffing, or previews -- especially
for a large or multilingual site.
...
[Add your favicons]: /docs/content/media/#add-your-favicons
...
[Docsy as an NPM package]: /docs/tutorial/install/
[docsy-example]: https://github.com/google/docsy-example
[experimental]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[hugo-language-apis]: /blog/docsy/hugo-0.158.0+/#language-apis
[hugo-upgrade]: /blog/docsy/hugo-0.158.0+/
[hugo-upgrade-install]: /blog/docsy/hugo-0.158.0+/#upgrade
[hugo-npm-pack]: https://gohugo.io/hugo-modules/nodejs-dependencies/
[Install PostCSS]: /docs/tutorial/prerequisites/#no-frontend-toolchain
[Lychee]: https://github.com/lycheeverse/lychee
[more]: #npm-deps
[official support policy]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[Other installation options]: /docs/tutorial/install/
[order of steps]: /docs/upgrade/upgrade/
[overrides]: /docs/upgrade/upgrade/
[Update Docsy]: /docs/upgrade/
[update-hugo]: /docs/upgrade/upgrade/
[update-node]: /docs/upgrade/upgrade/
[update-theme]: /docs/upgrade/upgrade/
<!-- prettier-ignore-end -->
