...
[Migrating to Bootstrap 5.2](/blog/docsy/bootstrap-5-migration/).
...
[first post](/blog/docsy/bootstrap-5-migration/#migrating-docsy-based-projects),
...
[TL;DR](/blog/docsy/bootstrap-5-migration/#tldr) of the first post:

- [Mixin `media-breakpoint-down()` argument shift](/blog/docsy/bootstrap-5-migration/#mixin-media-breakpoint-down-argument-shift)
- [Grid `.row` and `.col` style changes](/blog/docsy/bootstrap-5-migration/#grid-row-and-col-style-changes-are-breaking)
- [Import ordering of Bootstrap Sass files: functions first](/blog/docsy/bootstrap-5-migration/#import-ordering-of-bootstrap-sass-files-functions-first)
...
This, and the
[`.row` and `.col` style changes](/blog/docsy/bootstrap-5-migration/#grid-row-and-col-style-changes-are-breaking),
...
[CHANGELOG at 0.7.0](https://github.com/google/docsy/blob/main/CHANGELOG.md).
...
[Docsy for a new website](/docs/tutorial/project-site/). The example site
features [multi-language support](/docs/configure/language/), which had an
impact on the required upgrades.
...
- [blocks/section](/docs/components/layout/#blocks-section) changes
