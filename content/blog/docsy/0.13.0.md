...
> [!NOTE] Highlights
> - <i class="fa-solid fa-fire text-warning fa-lg"></i> <span>Docsy [0.13.0][] includes the
...
- <i class="fa-solid fa-compass px-1"></i> [Navigation and UX](#navigation-and-ux)
...
- <i class="fa-solid fa-code px-1"></i> [Alert shortcode](#alert-shortcode) rewrite for
  better Markdown support
- <i class="fa-solid fa-universal-access px-1"></i> [Accessibility](#accessibility)
...
This is a {{< badge text="BREAKING" tone="warning" >}} UX change. You can recover
...
- <i class="fa-solid fa-moon text-info px-1"></i> **[Dark mode][]**:
  ...
  - <i class="fa-solid fa-search text-info px-1"></i> **Google search** results page now supports
    dark-mode ([#2387][]). {{< badge text="EXPERIMENTAL" tone="info" >}}
