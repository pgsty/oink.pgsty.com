...
linkTitle: Docsy 0.13.0 release
date: 2025-11-24
...
>   more.</span>
> - <i class="fa-solid fa-check text-success fa-lg"></i> <span>This release has
>   new features and only
...
- <i class="fa-solid fa-code px-1"></i> [Alert shortcode](#alert-shortcode)
  rewrite for better Markdown support
...
- Review {{< badge text="BREAKING" tone="warning" >}} changes:
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Alert shortcode](#alert-shortcode) body content processing changes
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Language menu](#language-menu-visibility) visibility changes
- Optionally skim:
...
[TOC customization]: /docs/configure/navigation/#toc-customization
...
[docs-only]: /docs/content/organize/#alternative-site-structure
[Section sidebar root]: /docs/configure/navigation/#sidebar-root
...
This is a {{< badge text="BREAKING" tone="warning" >}} UX change. You can
recover legacy behavior as follows:
...
[lang-menu]: /docs/configure/navigation/#language-menu
...
- <i class="fa-solid fa-palette text-info px-1"></i> **Color contrast**
...
- <i class="fa-solid fa-moon text-info px-1"></i> **[Dark mode][]**:
  - <i class="fa-solid fa-bolt text-warning px-1"></i> [Flash Of Unstyled
    Content][] (FOUC) has been fixed ([#2332][]).
  - <i class="fa-solid fa-search text-info px-1"></i> **Google search** results
    page now supports dark-mode ([#2387][]).
    {{< badge text="EXPERIMENTAL" tone="info" >}}
...
[dark mode]: /docs/appearance/styling/#lightdark-color-modes
[Light/dark color modes]: /docs/appearance/styling/#lightdark-color-modes
...
[Site colors]: /docs/appearance/styling/#site-colors
...
[Docsy via NPM]: /docs/tutorial/install/
[translation files]: /docs/configure/language/#internationalization-bundles
[diagrams-formulae]: /docs/components/diagrams/#latex-support-with-katex

## <i class="fa-solid fa-rocket text-primary px-1"></i> Upgrade to 0.13.0 {#upgrade}

### Prerequisites

> <i class="fa-solid fa-triangle-exclamation text-warning px-1"></i> **We
> recommend** that you [Upgrade to Docsy 0.12.0][] first because it contains
> significant breaking changes.

### Upgrade procedure and AI help {#upgrading-and-ai}

> <i class="fa-solid fa-robot text-info px-1"></i> Have you used AI to help you
> upgrade Docsy? It can be a big help!
...
[alert]: /docs/components/layout/#alert
[CL@0.13.0]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[Upgrade to Docsy 0.12.0]: /blog/docsy/0.12.0/
[0.12.0 upgrade guide]: /blog/docsy/0.12.0/
[hugo-0.152.0]: /blog/docsy/hugo-0.152.0+/#0.152.0
