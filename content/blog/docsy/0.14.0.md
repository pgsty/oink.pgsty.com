...
linkTitle: Docsy 0.14.0 release
date: 2026-02-10
aliases: [/blog/2026/0.14.0/]
lastmod: 2026-02-17
description: >-
...
> - <i class="fa-solid fa-book text-info fa-lg"></i> <span>**Content and
>   localization**: new Markdown [alert syntax](#alerts) and
...
- Review {{< badge text="BREAKING" tone="warning" >}} changes:
  ...
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Heading aliases and in-page targets](#heading-aliases)
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [blocks/cover shortcode](#blocks-cover) content processing
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Hugo 0.155.0 requirement and 0.153+ breaking changes](#hugo)
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    (style-only) [Docsy 0.14.2 code-style update](#0.14.2) for light/dark mode
- Optionally skim:
  - <i class="fa-regular fa-square-check fa-lg text-success px-1"></i> New
    features (look for the green checkmark icon)
...
- <i class="fa-solid fa-rocket text-primary px-1"></i> Jump to
  [Upgrade to 0.14.0](#upgrade) once you are ready
...
<i class="fa-regular fa-wand-magic-sparkles fa-lg text-info px-1"></i> **Applies
...
[alert shortcode]: /docs/components/layout/#alert
[Alerts]: /docs/content/writing/#alerts
...
[internal]: https://github.com/google/docsy/blob/main/CHANGELOG.md
...
- <!-- markdownlint-disable no-space-in-emphasis -->
  ...
  <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i> /
  <i class="fa-regular fa-square-check fa-lg text-success px-1"></i> **Navbar
  light/dark color theme**: the always-dark navbar was an early Docsy constraint
  and isn’t a fit for all sites. You can now choose the theme that best matches
  your project’s overall design.
  - <i class="fa-regular fa-wand-magic-sparkles fa-lg text-info px-1"></i> If
    your design does not require a dark navbar, you may be able to drop any
    overrides you added just to force that theme.
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i> If
    your design does require a dark navbar, set `params.ui.navbar_theme` to
    `dark` to restore the previous behavior ([details][navbar-lightdark-theme]).

- <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
  **Navbar over cover**: applies if your project targets navbar cover
  translucency classes.
...
- **Navbar partial overrides:** applies if your project overrides the navbar
  ...
  > [!DETAILS]- Summary of edits to `layouts/_partials/navbar.html`
  >
  ...
  >   <tr><td>
  >     <ul>
  >       <li><code>&lt;nav&gt;</code> had <code>td-navbar-cover</code> only</li>
  >       <li>Projects used <code>.navbar-bg-on-scroll</code>, <code>.navbar-bg-onscroll--fade</code></li>
  >     </ul>
  >   </td><td class="border-start">
  >     <ul>
  >       <li><code>&lt;nav&gt;</code> gets <code>td-navbar-cover</code> and <code>td-navbar-transparent</code></li>
  >       <li>Old classes removed</li>
  >     </ul>
  >   </td></tr>
  >   <tr><th class="text-center" colspan="2" scope="colgroup">Light/dark theme</th></tr>
  >   <tr><td>
  >     <ul>
  >       <li><code>data-bs-theme="dark"</code> always set on <code>&lt;nav&gt;</code></li>
  >     </ul>
  >   </td><td class="border-start">
  >     <ul>
  >       <li><code>data-bs-theme="dark"</code> only when <code>params.ui.navbar_theme</code> is <code>"dark"</code></li>
  >       <li>Otherwise follows site theme</li>
  >     </ul>
  >   </td></tr>
  >   </tbody>
  > </table>
...
[Customizing the navbar]: /docs/appearance/styling/#navbar-customization
[Light/dark color theme]: /docs/appearance/styling/#navbar-lightdark-theme
[navbar]: /docs/appearance/styling/#navbar
[navbar-lightdark-theme]: /docs/appearance/styling/#navbar-lightdark-theme
[navbar cover-image translucency]:
  /docs/appearance/styling/#customize-over-cover
...
- <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
  **Applies if** your site uses `td-offset-anchor`; for example, if you override
  `blocks/lead.html`, `blocks/section.html`, or `layouts/community/list.html`.
...
[heading-aliases+]: /docs/configure/navigation/#heading-aliases
[heading-aliases-impl-notes]:
  /docs/configure/navigation/#heading-aliases-implementation-notes
...
> [!DETAILS]- Internal `assets/scss/` files moved into the `td/` subdirectory
>
> ```text
> assets/scss/
> ├── _alerts.scss
...
[breaking change]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[Swagger UI]: /docs/components/layout/#swaggerui
...
- <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
  **Applies if** you use `blocks/cover` in `.html` content files with Markdown
  in the body.
...
- <i class="fa-regular fa-square-check fa-lg text-success px-1"></i>
  **Recommended** for most projects.[^below-navbar-default] If you want to
  position your `blocks/cover` below the navbar (instead of behind it), add the
  `td-below-navbar` helper class to your `blocks/cover` call. For example:
  `height="auto td-below-navbar"`. See [Below-navbar height adjustment][].
...
[below-navbar height adjustment]: /docs/components/layout/#td-below-navbar
[blocks/cover]: /docs/components/layout/#blocks-cover
...
- <i class="fa-regular fa-square-check fa-lg text-success px-1"></i> Console
  block selection and copy-code now include commands only, not output
  ([#2548][]). For details, see [Selecting console block content][].
...
- <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
  **Applies if** you use `td/code-dark` and you want to revert to the
  `tango`/`onedark` styles. Follow the steps in [Light/dark code styles and
  more][].
...
[Light/dark code styles and more]:
  /docs/appearance/styling/#lightdark-code-styles
[Selecting console block content]:
  /docs/appearance/styling/#selecting-console-block-content

## Other notable Docsy changes {#other-notable-changes}

### <i class="fa-solid fa-globe px-1"></i> Internationalization {#internationalization}
...
[Extra styles]: /docs/appearance/styling/#extra-styles

### Shortcodes

- New [experimental][] `td/site-build-info/netlify` shortcode for Netlify build
  info. See an [example](https://github.com/pgsty/oink.pgsty.com).

### Clarified public vs internal theme features

Docsy 0.14.0 adds
[definitions](https://github.com/google/docsy/blob/main/CHANGELOG.md) to clarify
Docsy's public customization surface, internal/private features, and support
limits, so expectations are clear about what’s supported and what changes
require action:

- [Public customization surface](https://github.com/google/docsy/blob/main/CHANGELOG.md)
- [Private/internal features](https://github.com/google/docsy/blob/main/CHANGELOG.md)
- [Experimental features][experimental]
- [Breaking change](https://github.com/google/docsy/blob/main/CHANGELOG.md)
- [Official support limits](https://github.com/google/docsy/blob/main/CHANGELOG.md)
...
>       resolve to the correct language version. See [Hugo 0.152.0-0.155.x
>       upgrade guide][hugo-0.152.0+] for alias-related changes in 0.153+.
>
...
> those overrides against the changes in this release. This often lets you
> remove custom CSS/SCSS and reduce [technical debt][].
>
...
> - [ ] If you use `td/code-dark`, code block styles in light and dark mode
...
>
> [assets/js/base.js]:
>   https://github.com/google/docsy/blob/v0.14.0/assets/js/base.js?plain=1
> [render-blockquote-alert.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_markup/render-blockquote-alert.html?plain=1
> [sidebar.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_partials/sidebar.html?plain=1
> [sidebar-tree.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_partials/sidebar-tree.html?plain=1
> [blocks/cover.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_shortcodes/blocks/cover.html?plain=1
> [blocks/lead.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_shortcodes/blocks/lead.html?plain=1
> [blocks/section.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_shortcodes/blocks/section.html?plain=1
> [pageinfo.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_shortcodes/pageinfo.html?plain=1
> [site-build-info-netlify.md]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/_shortcodes/td/site-build-info/netlify.md?plain=1
> [blog/baseof.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/blog/baseof.html?plain=1
> [community/list.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/community/list.html?plain=1
> [docs/baseof.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/docs/baseof.html?plain=1
> [swagger/baseof.html]:
>   https://github.com/google/docsy/blob/v0.14.0/layouts/swagger/baseof.html?plain=1
>
> </section>
...
- [0.13.0 upgrade guide](/blog/docsy/0.13.0/)
...
[0.13.0]: https://github.com/google/docsy/blob/main/CHANGELOG.md
...
[Advanced style customization]:
  /docs/appearance/styling/#advanced-style-customization
[CL@0.14.0]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[CL@0.14.1]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[CL@0.14.2]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[CL@0.14.3]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[experimental]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[hugo-0.152.0+]: /blog/docsy/hugo-0.152.0+/
[officially supports]: https://github.com/google/docsy/blob/main/CHANGELOG.md
[Project style files]: /docs/appearance/styling/#project-style-files
[Project styles]: /docs/appearance/styling/#project-styles
[technical debt]: https://martinfowler.com/bliki/TechnicalDebt.html
[Testing checklist]: /blog/docsy/0.12.0/#testing-checklist
[Upgrade to Docsy 0.12.0]: /blog/docsy/0.12.0/
[Upgrade to Docsy 0.13.0]: /blog/docsy/0.13.0/
