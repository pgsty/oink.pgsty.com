...
linkTitle: Docsy 0.12.0 升级
date: 2025-11-11
aliases: [/blog/2025/0.12.0/]
lastmod: 2026-07-28
author: >-
...
[0.11.0]: https://github.com/google/docsy/blob/main/CHANGELOG.md
...
> [!IMPORTANT]
>
> 升级到 [0.16.0](/zh/blog/docsy/0.16.0/)
> 或更高版本时，请使用[更新 Docsy](/zh/docs/upgrade/)流程。
...
[images]: /zh/docs/content/media/#landing-pages
...
[标题自链接]: /zh/docs/configure/navigation/#heading-self-links

## 参考资料 {#references}

完整发布说明见：

- [Docsy v0.12.0 Changelog](https://github.com/google/docsy/blob/main/CHANGELOG.md)
...
- [0.11.0 版本亮点](/zh/blog/docsy/year-in-review/#release-highlights)
- [0.11.0 Changelog](https://github.com/google/docsy/blob/main/CHANGELOG.md)
- [Docsy Issue #2243][#2243]：_适配 Hugo v0.146.0 新模板系统_
- [0.13.0 发布报告与升级指南](/zh/blog/docsy/0.13.0/)——从 0.12.0 升级到 0.13.0
