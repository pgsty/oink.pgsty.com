...
linkTitle: Docsy 0.15.0 release
date: 2026-05-01
...
>   <span>**[Agent support](#agent-support)**: `llms.txt`, Markdown page output,
>   and a "View Markdown" page-meta link</span>
...
- Review {{< badge text="BREAKING" tone="warning" >}} changes:
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Community and footer links](#community-footer-links)
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Version menu entries](#version-menu)
  - <i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
    [Card shortcode rendering](#card-shortcode) (low risk)
- Optionally skim:
...
- <i class="fa-solid fa-rocket text-primary px-1"></i> Jump to
  [Upgrade to 0.15.0](#upgrade) once you are ready
...
URLs such as `/get-started/` instead of `/docs/tutorial/`.
...
[old-docs-only-config]:
  https://web.archive.org/web/20260216125700/https://www.docsy.dev/docs/content/organize/#alternative-site-structure
...
<i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
**Applies if** your project configures `params.versions` and customizes the
version menu or navbar.
...
<i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
**Applies if** your multilingual site configures community or footer links with
site-local paths.
...
<i class="fa-solid fa-triangle-exclamation fa-lg text-warning px-1"></i>
**Applies if** your project uses the [card.html][] shortcode or maintains a
custom override.
...
> <i class="fa-solid fa-robot text-info px-1"></i> **Upgrading with AI?** 0.15.0
> ships an experimental machine-readable
> [upgrade manifest](/upgrades/0.15.0.yaml) with upgrade-detection rules,
> applies-if gates, sanity checks, and per-item references. Use this release
> report and the manifest as context for your AI assistant.
...
[Adding a community page]: /docs/content/writing/#adding-a-community-page
[Adding a version drop-down menu]: /docs/configure/versioning/#adding-a-version-drop-down-menu
[card shortcode]: /docs/components/layout/#shortcode-card-textual-content
...
[Doc-rooted sites]: /docs/content/organize/#doc-rooted-sites
...
[multilingual sites]: /docs/configure/language/
...
[Version menu]: /docs/configure/navigation/#version-menu
<!-- prettier-ignore-end -->
