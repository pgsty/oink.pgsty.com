...
linkTitle: Docsy and Hugo 0.158+ upgrade
date: 2026-07-28
aliases: [/blog/2026/hugo-0.158.0+/]
lastmod: 2026-07-29
description: >-
...
This post is a companion to the
[Docsy 0.16.0 release post](/blog/docsy/0.16.0/), which specifies the
[Hugo versions that 0.16.0 requires and validates](/blog/docsy/0.16.0/#hugo).
...
behind 0.16.0's [raised Hugo minimum](/blog/docsy/0.16.0/#hugo).
...
- Upgrading as part of [Docsy 0.16.0](/blog/docsy/0.16.0/)? Continue with its
  [upgrade section](/blog/docsy/0.16.0/#upgrade).
