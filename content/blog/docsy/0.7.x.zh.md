...
完整变更清单请查看
[0.7.0 CHANGELOG](https://github.com/google/docsy/blob/main/CHANGELOG.md)。
...
[GitHub 模板](https://gitprotect.io/blog/how-to-use-github-repository-templates/)，我们通常建议准备[用 Docsy 创建新站点](/zh/docs/tutorial/project-site/)的用户从这里起步。示例站支持[多语言](/zh/docs/configure/language/)，这也影响了所需升级工作。

示例站升级甚至比 OTel 更简单。关键变更（[PR #221](https://github.com/google/docsy-example/pull/221)）主要集中在各语言的落地页：

- 工具类从 `.ml-*`、`.mr-*` 等改为 `.ms-*`、`.me-*`；
- [blocks/section](/zh/docs/components/layout/#blocks-section)
