...
title: Architecture
weight: 20
description: How Oink turns content and local assets into a documentation site
---
...
- JavaScript in ECharts is rejected unless an explicit unsafe migration switch
  is enabled;
