...
title: 'Create a new site: start from scratch'
linkTitle: Start from scratch
date: 2021-12-08T09:21:54+01:00
weight: 3
description: Create a minimal bilingual OINK site without a frontend toolchain.
---

The independent [bilingual project site](example-site-as-template/) is a useful
reference. Use this procedure to create a smaller site with its own content
structure.
...
- Expand the [basic configuration](/docs/get-started/basic-configuration/).
- Learn how to [add content](/docs/content/adding-content/).
- Review the [OINK architecture](/docs/oink/architecture/).
- Select a [deployment target](/docs/deployment/).
