...
独立的[双语项目站点](example-site-as-template/)是完整参考。需要更小、拥有自身内容结构的站点时，可以采用本流程。
...
- 扩展[基础配置](/zh/docs/get-started/basic-configuration/)。
- 学习如何[添加内容](/zh/docs/content/adding-content/)。
- 查看 [OINK 架构](/zh/docs/oink/architecture/)。
- 选择[部署目标](/zh/docs/deployment/)。
