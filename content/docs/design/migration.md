...
description: The supported source, configuration, and validation boundaries for migration from OINK 0.4 through OINK 0.8.1.
weight: 50
...
> This is the migration contract released with OINK 0.8.1. This page is the
