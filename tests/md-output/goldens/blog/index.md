...
> Release notes, upgrade guidance, and OINK engineering stories
...
- [Introducing the OINK implementation preview](/blog/2026/oink-announcement/): OINK turns a directly customized Docsy codebase into a local-first, Hugo-only documentation theme with multilingual infrastructure and reusable content components.
- [OINK implementation diary: from copied shells to one theme](/blog/2026/oink-implementation-diary/): A technical diary of the decisions, migrations, safety boundaries, tests, and documentation work behind the OINK implementation preview.
